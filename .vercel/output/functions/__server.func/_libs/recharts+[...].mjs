...
var adaptEventsOfChild = function adaptEventsOfChild(props, data, index) {
	if (!(0, import_isObject.default)(props) || _typeof$35(props) !== "object") return null;
	var out = null;
...
var isSingleChildEqual = function isSingleChildEqual(nextChild, prevChild) {
	...
	if (!(0, import_isNil.default)(nextChild) && !(0, import_isNil.default)(prevChild)) {
		...
		var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$14(_ref2, _excluded2$5);
...
var DefaultLegendContent = /*#__PURE__*/ function(_PureComponent) {
	function DefaultLegendContent() {
		_classCallCheck$15(this, DefaultLegendContent);
		return _callSuper$12(this, DefaultLegendContent, arguments);
	}
	_inherits$12(DefaultLegendContent, _PureComponent);
	return _createClass$15(DefaultLegendContent, [
		{
			key: "renderIcon",
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx(_defineProperty$32(_defineProperty$32({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
...
_defineProperty$32(DefaultLegendContent, "displayName", "Legend");
_defineProperty$32(DefaultLegendContent, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
	verticalAlign: "middle",
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		var _this;
		_classCallCheck$14(this, Legend);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$11(this, Legend, [].concat(args));
		_defineProperty$31(_this, "lastBoundingBox", {
			width: -1,
			height: -1
		});
		return _this;
	}
	_inherits$11(Legend, _PureComponent);
	return _createClass$14(Legend, [
		{
...
_defineProperty$31(Legend, "displayName", "Legend");
_defineProperty$31(Legend, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
...
function getTooltipCSSClassName(_ref) {
	...
	return clsx(CSS_CLASS_PREFIX, _defineProperty$29(_defineProperty$29(_defineProperty$29(_defineProperty$29({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var TooltipBoundingBox = /*#__PURE__*/ function(_PureComponent) {
	function TooltipBoundingBox() {
		var _this;
		_classCallCheck$13(this, TooltipBoundingBox);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$10(this, TooltipBoundingBox, [].concat(args));
		_defineProperty$28(_this, "state", {
			dismissed: false,
		...
		_defineProperty$28(_this, "handleKeyDown", function(event) {
			if (event.key === "Escape") {
	...
	_inherits$10(TooltipBoundingBox, _PureComponent);
	return _createClass$13(TooltipBoundingBox, [
		{
			key: "updateBBox",
			value: function updateBBox() {
				if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
...
_defineProperty$27(Tooltip, "displayName", "Tooltip");
_defineProperty$27(Tooltip, "defaultProps", {
...
function _defineProperties$11(target, props) {
	for (var i = 0; i < props.length; i++) {
		...
		descriptor.configurable = true;
		if ("value" in descriptor) descriptor.writable = true;
		Object.defineProperty(target, _toPropertyKey$25(descriptor.key), descriptor);
	}
}
...
var DecimalCSS = /*#__PURE__*/ function() {
	function DecimalCSS(num, unit) {
		_classCallCheck$11(this, DecimalCSS);
		this.num = num;
		this.unit = unit;
		this.num = num;
		this.unit = unit;
	...
	return _createClass$11(DecimalCSS, [
		{
			key: "add",
...
var Text = function Text(_ref5) {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$9(props, _excluded2$4);
...
var ErrorBar = /*#__PURE__*/ function(_React$Component) {
	function ErrorBar() {
		_classCallCheck$10(this, ErrorBar);
		return _callSuper$8(this, ErrorBar, arguments);
	}
	_inherits$8(ErrorBar, _React$Component);
	return _createClass$10(ErrorBar, [{
		key: "render",
		value: function render() {
...
_defineProperty$24(ErrorBar, "defaultProps", {
	stroke: "black",
	strokeWidth: 1.5,
	width: 5,
	offset: 0,
...
_defineProperty$24(ErrorBar, "displayName", "ErrorBar");
//#endregion
...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$21(_objectSpread$21({}, offset), {}, _defineProperty$22({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$21(_objectSpread$21({}, offset), {}, _defineProperty$22({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		...
		return _objectSpread$21(_objectSpread$21({}, result), {}, _defineProperty$22({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$21(_objectSpread$21({}, res), {}, _defineProperty$22({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$21(_objectSpread$21({}, result), {}, _defineProperty$22({}, axisId, group));
	}, {});
};
/**
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		var ticks = getTicksOfScale(scale, _objectSpread$20(_objectSpread$20({}, axis), {}, { realScaleType }));
		var finalAxis = _objectSpread$20(_objectSpread$20(_objectSpread$20({}, axis), ticks), {}, {
			range,
			radius: outerRadius,
			realScaleType,
			scale,
		...
		return _objectSpread$20(_objectSpread$20({}, result), {}, _defineProperty$21({}, id, finalAxis));
	}, {});
};
...
function LabelList(_ref) {
	...
	var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$6(restProps, _excluded2$3);
...
var Polygon = function Polygon(props) {
	...
	if (baseLinePoints && baseLinePoints.length) {
		...
		return /*#__PURE__*/ import_react.createElement("g", { className: layerClass }, /*#__PURE__*/ import_react.createElement("path", _extends$12({}, filterProps(others, true), {
			fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
			stroke: "none",
			d: rangePath
		})), hasStroke ? /*#__PURE__*/ import_react.createElement("path", _extends$12({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(points, connectNulls)
		})) : null, hasStroke ? /*#__PURE__*/ import_react.createElement("path", _extends$12({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(baseLinePoints, connectNulls)
		})) : null);
	}
	var singlePath = getSinglePolygonPath(points, connectNulls);
	return /*#__PURE__*/ import_react.createElement("path", _extends$12({}, filterProps(others, true), {
...
var Dot = function Dot(props) {
	...
	if (cx === +cx && cy === +cy && r === +r) return /*#__PURE__*/ import_react.createElement("circle", _extends$11({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var Cross = function Cross(_ref) {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$4(_ref, _excluded$4);
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$10({}, filterProps(props, true), {
	...
	return _createClass$9(PolarRadiusAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$13(_objectSpread$13(_objectSpread$13({}, filterProps(others, false)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
					x1: point0.x,
					y1: point0.y,
					x2: point1.x,
					y2: point1.y
				});
				return /*#__PURE__*/ import_react.createElement("line", _extends$9({ className: "recharts-polar-radius-axis-line" }, props));
			}
		},
		{
			key: "renderTicks",
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$9({}, props, { className: "recharts-polar-radius-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$14(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$14(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$14(PolarRadiusAxis, "defaultProps", {
	type: "number",
	radiusAxisId: 0,
	cx: 0,
	cy: 0,
	...
	return _createClass$8(PolarAngleAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$12(_objectSpread$12({}, filterProps(this.props, false)), {}, { fill: "none" }, filterProps(axisLine, false));
				if (axisLineType === "circle") return /*#__PURE__*/ import_react.createElement(Dot, _extends$8({ className: "recharts-polar-angle-axis-line" }, props, {
					cx,
					cy,
					r: radius
				}));
				...
				return /*#__PURE__*/ import_react.createElement(Polygon, _extends$8({ className: "recharts-polar-angle-axis-line" }, props, { points }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks() {
				...
				var items = ticks.map(function(entry, i) {
					...
					var tickProps = _objectSpread$12(_objectSpread$12(_objectSpread$12({ textAnchor: _this.getTickTextAnchor(entry) }, axisProps), {}, {
						stroke: "none",
						fill: stroke
					}, customTickProps), {}, {
						index: i,
					...
					return /*#__PURE__*/ import_react.createElement(Layer, _extends$8({
						...
						key: "tick-".concat(entry.coordinate)
					}, adaptEventsOfChild(_this.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$8({ className: "recharts-polar-angle-axis-tick-line" }, tickLineProps, lineCoord)), tick && PolarAngleAxis.renderTickItem(tick, tickProps, tickFormatter ? tickFormatter(entry.value, i) : entry.value));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$8({}, props, { className: "recharts-polar-angle-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$13(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$13(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$13(PolarAngleAxis, "defaultProps", {
	type: "category",
	angleAxisId: 0,
	scale: "auto",
	cx: 0,
...
var Trapezoid = function Trapezoid(props) {
	var trapezoidProps = _objectSpread$11(_objectSpread$11({}, defaultProps), props);
	var pathRef = (0, import_react.useRef)();
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(es6_default, {
		...
		return /*#__PURE__*/ import_react.createElement(es6_default, {
			...
			duration: animationDuration,
			easing: animationEasing
		}, /*#__PURE__*/ import_react.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
function Shape(_ref2) {
	var option = _ref2.option, shapeType = _ref2.shapeType, _ref2$propTransformer = _ref2.propTransformer, propTransformer = _ref2$propTransformer === void 0 ? defaultPropTransformer : _ref2$propTransformer, _ref2$activeClassName = _ref2.activeClassName, activeClassName = _ref2$activeClassName === void 0 ? "recharts-active-shape" : _ref2$activeClassName, isActive = _ref2.isActive, props = _objectWithoutProperties$2(_ref2, _excluded$2);
	var shape;
...
function typeGuardSectorProps(option, props) {
	...
	return _objectSpread$9(_objectSpread$9(_objectSpread$9({}, props), option), {}, {
		cx,
		cy
	});
}
function RadialBarSector(props) {
	return /*#__PURE__*/ import_react.createElement(Shape, _extends$6({
		shapeType: "sector",
...
var _excluded2$1 = ["value", "background"];
...
var RadialBar = /*#__PURE__*/ function(_PureComponent) {
	function RadialBar() {
		var _this;
		_classCallCheck$7(this, RadialBar);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$5(this, RadialBar, [].concat(args));
		_defineProperty$9(_this, "state", { isAnimationFinished: false });
	...
	_inherits$5(RadialBar, _PureComponent);
	return _createClass$7(RadialBar, [
		{
			key: "getDeltaAngle",
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({}, baseProps), {}, { cornerRadius: parseCornerRadius(cornerRadius) }, entry), adaptEventsOfChild(_this2.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(RadialBarSector, _extends$5({}, props, { key: "sector-".concat(i) }));
				});
			}
		},
		{
			...
			value: function renderSectorsWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						if (prev) {
							var interpolatorStartAngle = interpolateNumber$1(prev.startAngle, entry.startAngle);
							var interpolatorEndAngle = interpolateNumber$1(prev.endAngle, entry.endAngle);
						...
						var interpolator = interpolateNumber$1(startAngle, endAngle);
						return _objectSpread$8(_objectSpread$8({}, entry), {}, { endAngle: interpolator(t) });
					});
		...
		},
		{
			...
			value: function renderSectors() {
				...
				var prevData = this.state.prevData;
				if (isAnimationActive && data && data.length && (!prevData || !(0, import_isEqual.default)(prevData, data))) return this.renderSectorsWithAnimation();
		...
		},
		{
			...
			value: function renderBackground(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({ cornerRadius: parseCornerRadius(cornerRadius) }, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
						index: i,
...
_defineProperty$9(RadialBar, "displayName", "RadialBar");
_defineProperty$9(RadialBar, "defaultProps", {
	angleAxisId: 0,
	radiusAxisId: 0,
	minPointSize: 0,
	hide: false,
...
_defineProperty$9(RadialBar, "getComposedData", function(_ref2) {
	...
	return {
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({}, entry), backgroundSector), {}, {
				payload: entry,
	...
	return _createClass$6(Brush, [
		...
		},
		{
			...
			value: function renderText() {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-brush-texts" }, /*#__PURE__*/ import_react.createElement(Text, _extends$4({
					textAnchor: "end",
					verticalAnchor: "middle",
					x: Math.min(startX, endX) - offset,
					y: y + height / 2
				}, attrs), this.getTextOfTick(startIndex)), /*#__PURE__*/ import_react.createElement(Text, _extends$4({
					textAnchor: "start",
					verticalAnchor: "middle",
		...
		},
		{
			...
			value: function getDerivedStateFromProps(nextProps, prevState) {
				...
				if (data !== prevState.prevData || updateId !== prevState.prevUpdateId) return _objectSpread$6({
					prevData: data,
...
var renderLine = function renderLine(option, props) {
	...
	else line = /*#__PURE__*/ import_react.createElement("line", _extends$3({}, props, { className: "recharts-reference-line-line" }));
	return line;
};
...
function ReferenceLineImpl(props) {
	...
	var lineProps = _objectSpread$4(_objectSpread$4({ clipPath: ifOverflowMatches(props, "hidden") ? "url(#".concat(clipPathId, ")") : void 0 }, filterProps(props, true)), {}, {
		x1,
		y1,
		x2,
		y2
...
var ReferenceDot = /*#__PURE__*/ function(_React$Component) {
	...
	return _createClass$3(ReferenceDot, [{
		...
		value: function render() {
			...
			var dotProps = _objectSpread$3(_objectSpread$3({ clipPath: ifOverflowMatches(this.props, "hidden") ? "url(#".concat(clipPathId, ")") : void 0 }, filterProps(this.props, true)), {}, {
				cx,
				cy
			});
...
_defineProperty$4(ReferenceDot, "renderDot", function(option, props) {
	...
	else dot = /*#__PURE__*/ import_react.createElement(Dot, _extends$2({}, props, {
		cx: props.cx,
		cy: props.cy,
...
var ReferenceArea = /*#__PURE__*/ function(_React$Component) {
	...
	return _createClass$2(ReferenceArea, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(Layer, { className: clsx("recharts-reference-area", className) }, ReferenceArea.renderRect(shape, _objectSpread$2(_objectSpread$2({ clipPath }, filterProps(this.props, true)), rect)), Label.renderCallByParent(this.props, rect));
		}
	}]);
}(import_react.Component);
...
_defineProperty$3(ReferenceArea, "renderRect", function(option, props) {
	...
	else rect = /*#__PURE__*/ import_react.createElement(Rectangle, _extends$1({}, props, { className: "recharts-reference-area-rect" }));
	return rect;
});
//#endregion
...
*/
var RadialBarChart = function generateCategoricalChart(_ref6) {
...
//#endregion
export { ResponsiveContainer as i, RadialBar as n, PolarAngleAxis as r, RadialBarChart as t };
