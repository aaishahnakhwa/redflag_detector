...
import { A as isReactNative, C as getDefaultEmulatorHostnameAndPort, D as isEmpty, E as isCloudWorkstation, F as querystring, I as safeGet, L as stringLength, M as jsonEval, N as map, O as isMobileCordova, P as pingServer, R as stringToByteArray, S as errorPrefix, T as isAdmin, _ as base64Encode, a as getApp, b as deepCopy, c as registerVersion, d as Component, f as Deferred, g as base64, h as assertionError, i as _registerComponent, j as isValidFormat, k as isNodeSdk, l as LogLevel, m as assert, n as _getProvider, p as Sha1, r as _isFirebaseServerApp, t as SDK_VERSION$1, u as Logger, v as contains, w as getModularInstance, x as deepEqual, y as createMockUserToken, z as stringify } from "./app+[...].mjs";
...
var require_stream_reader = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	StreamReader.prototype.read = function(length) {
		...
		if (first.length >= length) if (first.length === length) return queue.shift();
		else {
...
var require_client$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var instance = {
		...
		_validateHandshake: function() {
			...
			this.protocol = null;
			if (protocol !== "") if (this._protocols.indexOf(protocol) < 0) return this._failHandshake("Sec-WebSocket-Protocol mismatch");
			...
			this._reader.eachByte(function(octet) {
				...
				switch (this._stage) {
					...
					case 1:
						...
						else if ((octet & 128) !== 128) if (this._length === 0) this._stage = 0;
						else {
							this._skipped = 0;
							this._stage = 2;
						}
...
//#endregion
export { set as i, push as n, ref as r, getDatabase as t };
